...
<link rel="shortcut icon" href="w.jpg" type="image/x-icon">
   ...
   <style>
     body{
    background-image:url("https://media.istockphoto.com/id/1089592832/vector/studio-room-blurred-background-soft-gradient-pastel-with-lighting-well-use-as-business.jpg?s=612x612&w=0&k=20&c=nm5mtV7RsQvvcRIIcbZkhxqOwK0sVIjbIjnNVd2ORew=");
...
<body>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="https://img.freepik.com/free-photo/sunset-pool_1203-3192.jpg?size=626&ext=jpg&ga=GA1.1.1324675553.1725190992&semt=ais_hybrid" alt="First slide" height="500px">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="https://img.freepik.com/free-photo/swimming-pool-beach-luxury-hotel-outdoor-pools-spa-amara-dolce-vita-luxury-hotel-resort-tekirova-kemer-turkey_146671-18751.jpg?size=626&ext=jpg&ga=GA1.1.1324675553.1725190992&semt=ais_hybrid" alt="Second slide" height="500px">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="https://img.freepik.com/free-photo/beautiful-tropical-beach-sea-with-umbrella-chair-around-swimming-pool_74190-1071.jpg?size=626&ext=jpg&ga=GA1.1.1324675553.1725190992&semt=ais_hybrid" alt="Third slide" height="500px">
    </div>
  </div>
...
<div class="col-sm-4">
<table style="width:100% ; height:500px; border:5px inset">
        <form action="signupcode.php" method="post">
            <tr ><th colspan="4" ><h2>Sign Up<h2></th></tr>
            <tr><td colspan="4"><input type="text" name="name" placeholder="Username"></td></tr>
            <tr><td colspan="4"><input type="email" name="email" placeholder="Email"></td></tr>
            <tr><td colspan="4"><input type="password" name="pass" placeholder="Password"></td></tr>
        <tr><td colspan="4"><button>Sign Up</button></td></tr>
        ...
        <tr><td colspan="4"><h5 >Already have an account?<a href="login.php">Login</a></h5></td></tr>
        </form>
    </table>
</div>
<div class="col-sm-4"></div>
